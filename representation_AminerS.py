...
beta_2 = 0.7
nheads_1 = 2 # intro subgraph
nheads_2 = 0 # inter subgraph

save_postfix = 'AminerS_opd_v2re_opdv2_3l2h_0.5drpt_0227_t0400'
# save_postfix = 'AminerS_opd_v2re_1layer_1heads_addfc_0224_t1410' # 0
num_rpt = 2
...
features, subgraphs,subgraphs_train_val_test, train_val_test_idx, labels, adj, type_mask, ontology_pairs = load_AminerS_data(prefix = data_path)
ontology_path = None
...
if __name__ == '__main__':
    node_representations = representations_generating_v2(net, subgraphs, features, type_mask, device, save_flag = True, max_size=10000, task = 'all_opd_v2')
    node_representations = np.load(data_path + '/representations/' + 'all_opd_v2' + '_node_representations.npy') # opd_v2_88
