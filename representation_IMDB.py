...
save_postfix = 'IMDB_opd_v2re_old_ohnnv3_full_withlogits_0306_t0050' # 9
# save_postfix = 'tmp' #rpt0
num_rpt = 1
...
features, subgraphs,subgraphs_train_val_test, train_val_test_idx, labels, adj, type_mask, ontology_pairs = load_IMDB_data(prefix = data_path)
ontology_path = None
...
if __name__ == '__main__':
    node_representations = representations_generating_v2(net, subgraphs, features, type_mask, device, save_flag = True, max_size=10000, task = 'opdv2_full')
    # node_representations = np.load(data_path + '/representations/' + 'opdv2_full' + '_node_representations.npy') # opd_v2_88
