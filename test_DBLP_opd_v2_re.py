...
features, subgraphs,subgraphs_train_val_test, train_val_test_idx, labels, adj, type_mask = load_DBLP_data2(prefix = data_path)
...
print(f'out_dim = {out_dim}, att_head_1 = {nheads_1}, att_head_2 = {nheads_2}, perturb ratio = {perturb_ratio}')
