...
save_postfix = 'Freebase_opd_v2re_opdv2_3l2h_0drpt_0227_t0150'
# save_postfix = 'AminerS_opd_v2re_1layer_1heads_addfc_0224_t1410' # rpt 0
num_rpt = 3

# data_path = r'F:/Data/OHNN/data/DBLP_processed/graph_split'
data_path = r'./data/Freebase_processed/graph_split'
device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')


features, subgraphs,subgraphs_train_val_test, train_val_test_idx, labels, adj, type_mask, ontology_pairs = load_Freebase_data(prefix = data_path)
ontology_path = None
